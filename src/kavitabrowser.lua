...
function KavitaBrowser:addEditServer(item, is_edit)
    ...
    local fields = {
        ...
        { hint = _("Server type: kavita or komga") },
    ...
    if is_edit then
        ...
        fields[4].text = original.server_type or "kavita"
        fields[5].text = original.username or nil
        fields[6].text = original.password or nil
    else
        title = _("Add server")
    end
